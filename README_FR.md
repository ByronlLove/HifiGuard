...
|--------------|---------------------------------------------------------------------------------------------------------------------------------|--------|----------------------------|
| Installateur | [`HifiGuard-Setup-1.1.1.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.1.1/HifiGuard-Setup-1.1.1.exe)       | 148 Mo | Aucun - Python est intégré |
| Portable     | [`HifiGuard-1.1.1-portable.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.1.1/HifiGuard-1.1.1-portable.exe) | 146 Mo | Aucun - Python est intégré |
