...
|--------------|---------------------------------------------------------------------------------------------------------------------------------|--------|----------------------------|
| Installateur | [`HifiGuard-Setup-1.2.0.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.2.0/HifiGuard-Setup-1.2.0.exe)       | 128 Mo | Aucun - Python est intégré |
| Portable     | [`HifiGuard-1.2.0-portable.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.2.0/HifiGuard-1.2.0-portable.exe) | 126 Mo | Aucun - Python est intégré |
