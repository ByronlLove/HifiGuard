...
Note : cette formule suppose que le fichier audio est à 0 dBFS. Si ton fichier est à -10 dBFS par exemple : dBFS total = dBFS_fichier + 20 × log10(% / 100)=-10 + 20 × log10(% / 100)****
