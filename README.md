...
|-----------|---------------------------------------------------------------------------------------------------------------------------------|--------|--------------------------|
| Installer | [`HifiGuard-Setup-1.1.1.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.1.1/HifiGuard-Setup-1.1.1.exe)       | 148 MB | None - Python is bundled |
| Portable  | [`HifiGuard-1.1.1-portable.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.1.1/HifiGuard-1.1.1-portable.exe) | 146 MB | None - Python is bundled |
