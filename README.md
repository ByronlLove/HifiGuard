...
| Portable  | [`HifiGuard-1.1.0-portable.exe`](https://github.com/ByronlLove/HifiGuard/releases/download/v1.10.0/HifiGuard-1.1.0-portable.exe) | 123 MB | None - Python is bundled |
